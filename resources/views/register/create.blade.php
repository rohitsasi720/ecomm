...
<div style="margin: 0 auto; margin-top: 50px; width: 400px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.3); padding: 20px; background-color: #f2f2f2;">
  <h2 style="text-align: center; margin-bottom: 20px;">Register</h2>
    <form method="POST" action="/register">
        @csrf
        <div class="mb-3">
    <label for="name" class="form-label" style="display: block; margin-bottom: 5px;">Name</label>
    <input type="text" name="name" class="form-control" id="name" value="{{old('name')}}" aria-describedby="nameHelp" style="display: block; width: 100%; padding: 10px; border-radius: 5px; border: none; margin-bottom: 20px;">
  </div>
  @error('name')
